    ...
    impl RdRandGenerator {
        ...
        pub fn new_if_supported() -> SyncByteStreamOrZeroes<Self> {
            match RdRand::new() {
                ...
                Err(err) => {
                    log::warn!("Not able to use RDRAND random generator. Generated bytes might be less random. Error message: {}", err);
    ...
    impl RdSeedGenerator {
        ...
        pub fn new_if_supported() -> SyncByteStreamOrZeroes<Self> {
            match RdSeed::new() {
                ...
                Err(err) => {
                    log::warn!("Not able to use RDSEED random generator. Generated bytes might be less random. Error message: {}", err);
                    SyncByteStreamOrZeroes::new_zeroes()
                }
            }
        }
...
mod implementation {
    ...
    impl RdRandGenerator {
        pub fn new_if_supported() -> ZeroesGenerator {
            log::warn!("RDRAND random generator unavailable on this platform. Generated bytes might be less random.");
            ZeroesGenerator
        }
    ...
    impl RdSeedGenerator {
        pub fn new_if_supported() -> ZeroesGenerator {
            log::warn!("RDSEED random generator unavailable on this platform. Generated bytes might be less random.");
            ZeroesGenerator
        }
    }
